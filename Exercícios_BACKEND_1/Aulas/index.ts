...
class Coruja{
    ...
    constructor(nome:string, altura:number, especie:string, habilidade:string ){
        this.nome = nome
        this.altura = altura
        ...
        especie():void {
            console.log('Coruja-das-torres (Tyto furcata). ')
         }
        habilidade():void {
            console.log('voo e caça.')
         }
}
}
const Coruja:Coruja = new Coruja('Coruja-das-torres',35,'Tyto furcata','voo e caça')
