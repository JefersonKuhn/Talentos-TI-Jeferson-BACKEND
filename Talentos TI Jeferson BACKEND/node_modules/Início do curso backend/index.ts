...
/*class Coruja{
    ...
    constructor(nome:string, tamanho:number, especie:string, habilidade:string ){
        this.nome = 'Coruja da torre'
...
const coruja:Coruja = new Coruja('Coruja da torre',35,'Tyto alba',"voo e caça")

console.log(coruja.nome)

coruja.altura()
coruja.nomeDaEspecie()
coruja.aptidao()*/
