...
USE empresa_jeferson;
UPDATE empregados SET titulo = 'Gerente' WHERE nome = 'Tiringa';
UPDATE empregados SET titulo = 'Assistente' WHERE nome = 'Luiz do Som';
UPDATE empregados SET titulo = 'Analista' WHERE nome = 'Musão';
UPDATE empregados SET titulo = 'Desenvolvedor' WHERE nome = 'Pililiu';
UPDATE empregados SET titulo = 'Engenheiro' WHERE nome = 'Zé';
UPDATE empregados SET titulo = 'Assistente' WHERE nome = 'Tião';
UPDATE empregados SET titulo = 'Analista' WHERE nome = 'Barba';
UPDATE empregados SET titulo = 'Estagiário' WHERE nome = 'Tonho';
...
GROUP BY (cargos.salario) > 5000.00;
